---
title: "Homework #2, DSA 5103 Fall 2016"
author: "Sanjiv Shah (OU ID 113180542)"
...
```{r}
boxplot(GSAFdata$daysbetwn, notch=TRUE,col="beige", horizontal = TRUE, xlab="Days between shark attacks", main="Box plot of days between shark attacks") 
adjbox(GSAFdata$daysbetwn,notch=TRUE,col="beige", horizontal = TRUE, xlab="Days between shark attacks",main="Adjusted Box plot of days between shark attacks")
```
####4(f)(iii) Grubbs test
```{r}
...
####Dataset: Digit 4 
```{r}
screeplot(prcomp4,npcs=25, type="lines", main="Screeplot: Digit5",cex=1.5, cex.lab=1.5, cex.axis=1.5) 
